        ...
        <section className="py-16 px-4 bg-gray-100">
            <div className="max-w-7xl mx-auto">
                ...
                <div className="text-center mb-12">
                    <p className="text-orange-500 text-base font-normal mb-2">{t('services.subtitle') || 'A Propos'}</p>
                    <h2 className="text-gray-800 text-5xl font-bold mb-4">{t('services.title') || 'Nos Services'}</h2>
                    ...
                    <p className="text-gray-700 text-base leading-relaxed max-w-3xl mx-auto mb-8">
                        {t('services.pack.description') || "Aujourd'hui, le monde fait face à des défis extraordinaires. D'un côté, nous avons le développement exponentiel de la démographie et la raréfaction des ressources."}
                    </p>
                </div>
                ...
                <div className="flex flex-wrap justify-center gap-4 mb-12">
                    {services.map((service) => (
                        <button
                            key={service.id}
                            className={`px-8 py-4 rounded-lg border transition-all ${activeService === service.id
                ...
                <div className="grid grid-cols-1 lg:grid-cols-2 gap-12 items-center">
                    ...
                    <div className="space-y-6">
                        ...
                        <div className="flex items-center gap-3">
                            ...
                            />
                            <h4 className="text-xl font-medium text-gray-800">{t('services.pack.title') || 'Pack Startup'}</h4>
                        </div>
