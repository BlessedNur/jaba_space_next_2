...
const HomeHeroSection: React.FC<HomeHeroSectionProps> = ({
  ...
  return (
    <section
      className={`relative min-h-screen flex items-center justify-center mt-[5em] ${className}`}
    >
      {/* Background Images */}
      {heroImages.map((image, index) => (
        <div
          key={index}
          className={`absolute inset-0 z-0 transition-opacity duration-1000 bg-cover  bg-no-repeat ${
