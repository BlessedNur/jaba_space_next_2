...
const Header: React.FC<HeaderProps> = ({ className = "" }) => {
  ...
  return (
    <header
      className={`bg-white shadow-md fixed top-0 left-0 right-0 z-50 ${className}`}
    >
      <div className="w-full px-4 py-4">
        <div className="flex justify-between items-center">
          ...
          {/* Social Media Icons and Language Switcher for Desktop and Tablet */}
          <div className="hidden lg:flex items-center space-x-2 xl:space-x-3">
            ...
            <button
              ...
              className="bg-gray-200 px-2 py-1 xl:px-3 xl:py-1 rounded text-xs xl:text-sm font-semibold hover:bg-orange-100 transition-colors ml-2"
        ...
        {isMenuOpen && (
          <div className="lg:hidden mt-4 pb-4 border-t border-gray-200 relative">
            ...
            <nav className="flex flex-col items-center space-y-3 sm:space-y-4 pt-4">
              <Link
                href="/"
            ...
            {/* Social Media Icons and Language Switcher for Mobile and Tablet */}
            <div className="flex justify-center items-center space-x-2 sm:space-x-3 mt-4">
              ...
              <button
                onClick={() => setLanguage(language === "en" ? "fr" : "en")}
                className="bg-gray-200 px-2 py-1 sm:px-3 sm:py-1 rounded text-xs sm:text-sm font-semibold hover:bg-orange-100 transition-colors ml-2"
                aria-label="Switch language"
              >
                {language === "en" ? "FR" : "EN"}
              </button>
